...
export default function ProfileScreen() {
  ...
  const loadUserData = async () => {
    try {
      ...
      console.log("DATA SESI TERPANTAU:", jsonValue);
  ...
  // 2. Fungsi untuk inisial nama di dalam avatar
  ...
  // 3. Fungsi format singkatan gaji
  ...
  // 4. Logika Update Password ke API Laravel (Menggunakan 127.0.0.1)
  const handleUpdatePassword = async () => {
    ...
    setUpdating(true);
    try {
      const API_URL = `http://127.0.0.1:8000/api/usersupdate/${userData?.id_user}`;
  ...
  // PERBAIKAN BUG: Menggunakan parameter screenName yang benar
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.headerBanner}>
          {/* Tombol Back diselaraskan ke halaman utama owner */}
          <TouchableOpacity style={styles.backButtonTop} onPress={() => router.push('/owner')}>
          ...
          <View style={styles.profileMetaRow}>
            <View style={styles.metaLeft}>
              ...
              <View style={styles.jobRow}>
                ...
                <Text style={styles.jobText}>{userData?.jabatan || 'Jabatan'}</Text>
              </View>
            </View>
