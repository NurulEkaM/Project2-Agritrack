...
<body>
  ...
  <div class="header">
        <h1>CASHFLOW KIWARI FARM</h1>
        <p>Periode: {{ \Carbon\Carbon::create()->month((int)request('bulan', now()->month))->translatedFormat('F') }} {{ request('tahun', now()->year) }}</p>
    </div>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{ $isNewDate ? $tanggal->translatedFormat('F') : '' }}</td>
        ...
        <tfoot>
            <tr class="bg-total">
                <td colspan="4" class="text-right">TOTAL PER KATEGORI</td>
            ...
            <tr>
                ...
                <td colspan="3" class="text-center text-red" style="font-weight: bold; font-size: 11px;">
                    Rp {{ number_format($totalPengeluaran, 0, ',', '.') }}
                </td>
            </tr>
            <tr style="background-color: #064E3B; color: white;">
                <td colspan="4" class="text-right" style="font-weight: bold;">SALDO BERSIH (NET BALANCE)</td>
